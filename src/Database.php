...
class Database extends \PDO
{
    ...
    private $html;
    public $debug = false;
    public $paginationItem = '<li><a class="page btn btn-outline-primary ms-1 fs-1 [active]" href="[url]">[text]</a> </li>';
    public $reference = [
        'NOW()'
    ];
    ...
    public function dual_orderby($columnName1,$columnName2,$sort1='ASC',$sort2='ASC'){
        $this->orderBy=' ORDER BY '.$columnName1.' '.strtoupper($sort1).', '.$columnName2.' '.strtoupper($sort2);
        return $this;
    }

    public function custom_orderby($o_sql)
    {
        $this->orderBy = ' '.$o_sql;
        return $this;
    }
    ...
    public function custom_where($column, $value=1)
    {
        $this->where($column, $value, 'CUSTOM');
        return $this;
    }
